  ...
  if (!profile || !routine) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
        <div className="w-20 h-20 rounded-full bg-brand-pale flex items-center justify-center mb-6">
        ...
        <Link to="/Landing">
          <Button className="bg-brand hover:bg-brand-dark rounded-full px-8 py-6 text-base">
            Começar Quiz
    ...
    <div className="space-y-6 pb-8">
      <div className="bg-gradient-to-br from-brand to-brand-light rounded-3xl p-6 text-white">
        <div className="flex items-start justify-between">
          <div>
            <p className="text-white/80 text-sm font-medium">Sua Rotina Personalizada</p>
        ...
        <div className="grid grid-cols-3 gap-4 mt-6">
          <div className="bg-white/10 rounded-xl p-3 text-center">
            <p className="text-white/70 text-xs">Tipo de Pele</p>
            <p className="font-semibold mt-1">{skinTypeLabels[profile.skin_type] || profile.skin_type}</p>
          </div>
          <div className="bg-white/10 rounded-xl p-3 text-center">
            <p className="text-white/70 text-xs">Idade da Pele</p>
            <p className="font-semibold mt-1">{profile.skin_age_score || '—'} anos</p>
          </div>
          <div className="bg-white/10 rounded-xl p-3 text-center">
            <p className="text-white/70 text-xs">Tempo Diário</p>
      ...
      {routine.expected_results && (
        <div className="bg-brand-bg rounded-2xl p-5 border border-brand-pale">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Link to="/Plan30Days" className="bg-white rounded-2xl p-5 border border-stone-200 hover:border-brand-light hover:bg-brand-bg/50 transition-all">
        ...
        <Link to="/Recipes" className="bg-white rounded-2xl p-5 border border-stone-200 hover:border-brand-light hover:bg-brand-bg/50 transition-all">
