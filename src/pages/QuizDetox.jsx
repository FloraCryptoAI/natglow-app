...
export default function QuizDetox({ pricingPlan = 'detox' }) {
  ...
  // from /quiz-v2 (legacy quiz assets already in public/). Emoji chosen
  // to evoke the issue visually without being alarming.
  const SYMPTOM_CARDS = [
    { img: '/images/quiz-v2/queda-crescimento.jpg', emoji: '🍂', label: t('quizDetox.symptoms.pills.hairLoss') },
    { img: '/images/quiz-v2/ressecado-frizz.jpg',   emoji: '⚡', label: t('quizDetox.symptoms.pills.nightItch') },
    { img: '/images/quiz-v2/sem-brilho.jpg',        emoji: '🌥️', label: t('quizDetox.symptoms.pills.itch') },
    { img: '/images/quiz-v2/oleoso.jpg',            emoji: '💧', label: t('quizDetox.symptoms.pills.grease') },
    { img: '/images/quiz-v2/quebra-pontas.jpg',     emoji: '✂️', label: t('quizDetox.symptoms.pills.sensitive') },
    { img: '/images/quiz-v2/sem-volume.jpg',        emoji: '🥀', label: t('quizDetox.symptoms.pills.weakHair') },
  ]
